...
export default class Complete extends React.Component {
    static async getInitialProps(context) {
        ...
        const res = await fetch(`http://3.1.203.88:8001/completed?page=${page}`)
                ...
                <div id="main_body">
                    <div className="cotgiua">
                                ...
                                <div>
                                    <p>
                                        ...
                                        >
                                            <Link
                                                itemProp="url"
                                                as={`/complete/page/${this.props.data.page}`}
                                                href={`/complete?page=${this.props.data.page}`}
                                            >
                        ...
                        <div className="phan-trang">
                            ...
                            <Link as={`/complete/page/${(parseInt(this.props.page) + 1)}`} href={`/complete?page=${(parseInt(this.props.page) + 1)}`}>
