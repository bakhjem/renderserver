...
export default class Update extends React.Component {
    static async getInitialProps(context) {
        ...
        const res = await fetch(`http://3.1.203.88:8001/genres?id=${id}&page=${page}`)
                ...
                <div id="main_body">
                    <div className="cotgiua">
                                ...
                                <div>
                                    <p>
                                        ...
                                        >
                                            <Link
                                                itemProp="url"
                                                as={`/theloai/${this.props.id}/page/${this.props.data.page}`}
                                                href={`/theloai?id=${this.props.id}&page=${this.props.data.page}`}
                                            >
                        ...
                        <div className="phan-trang">
                            ...
                            <Link as={`/theloai/${this.props.id}/page/${(parseInt(this.props.page) + 1)}`} href={`/theloai?id=${this.props.id}&page=${(parseInt(this.props.page) + 1)}`}>
