...
export default class Hot extends React.Component {
    static async getInitialProps(context) {
        ...
        const res = await fetch(`http://3.1.203.88:8001/hotnovel?page=${page}`)
                ...
                <div id="main_body">
                    <div className="cotgiua">
                                ...
                                <div>
                                    <p>
                                        ...
                                        >
                                            <Link
                                                itemProp="url"
                                                as={`/hot/page/${this.props.data.page}`}
                                                href={`/hot?page=${this.props.data.page}`}
                                            >
                        ...
                        <div className="phan-trang">
                            ...
                            <Link as={`/hot/page/${(parseInt(this.props.page) + 1)}`} href={`/hot?page=${(parseInt(this.props.page) + 1)}`}>
